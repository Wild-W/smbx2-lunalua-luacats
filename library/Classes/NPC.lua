...
--- @field layerName string The name of the NPC's layer.
--- @field attachedLayerObj Layer The attached layer of the NPC.
--- @field attachedLayerName string The name of the NPC's attached layer.
--- @field activateEventName string The name of the event executed when the NPC spawns.
--- @field deathEventName string The name of the event executed when the NPC dies.
--- @field talkEventName string The name of the event executed when the NPC is talked to.
--- @field noMoreObjInLayer string The name of the event executed when the NPC is killed and its layer becomes empty.
...
--- @field collisionGroup string The collision group this NPC belongs to.
...
--- @field msg string The NPC's talk message. If this is not an empty string, an exclamation point will appear above the NPC when the player gets close.
